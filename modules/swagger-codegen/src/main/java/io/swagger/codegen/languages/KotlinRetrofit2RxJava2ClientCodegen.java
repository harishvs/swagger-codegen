...
public class KotlinRetrofit2RxJava2ClientCodegen extends AbstractKotlinCodegen {

    public static final String DATE_LIBRARY = "dateLibrary";
    protected CodegenConstants.ENUM_PROPERTY_NAMING_TYPE enumPropertyNaming = CodegenConstants.ENUM_PROPERTY_NAMING_TYPE.camelCase;
    static Logger LOGGER = LoggerFactory.getLogger(KotlinRetrofit2RxJava2ClientCodegen.class);
     ...
     */
    public KotlinRetrofit2RxJava2ClientCodegen() {
        super();

        artifactId = "swagger-kotlin-rf2rx2";//todo make this a constant
        packageName = "io.swagger.client";

        outputFolder = "generated-code" + File.separator + "swagger-kotlin-rf2rx2";
        modelTemplateFiles.put("model.mustache", ".kt");
        apiTemplateFiles.put("api.mustache", ".kt");
        modelDocTemplateFiles.put("model_doc.mustache", ".md");
        apiDocTemplateFiles.put("api_doc.mustache", ".md");
        embeddedTemplateDir = templateDir = "kotlin-rf2rx2-client";
