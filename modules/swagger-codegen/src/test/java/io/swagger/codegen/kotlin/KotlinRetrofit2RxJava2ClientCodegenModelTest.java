...
public class KotlinRetrofit2RxJava2ClientCodegenModelTest {
    ...
    public void simpleModelTest() {
        ...
        final DefaultCodegen codegen = new KotlinRetrofit2RxJava2ClientCodegen();
    ...
    public void selectDateLibraryAsThreetenbp() {
        final Model model = getSimpleModel();
        final KotlinRetrofit2RxJava2ClientCodegen codegen = new KotlinRetrofit2RxJava2ClientCodegen();
        codegen.setDateLibrary(KotlinRetrofit2RxJava2ClientCodegen.DateLibrary.THREETENBP.value);
        codegen.processOpts();
    ...
    public void selectDateLibraryAsString() {
        final Model model = getSimpleModel();
        final KotlinRetrofit2RxJava2ClientCodegen codegen = new KotlinRetrofit2RxJava2ClientCodegen();
        codegen.setDateLibrary(KotlinRetrofit2RxJava2ClientCodegen.DateLibrary.STRING.value);
        codegen.processOpts();
    ...
    public void selectDateLibraryAsJava8() {
        final Model model = getSimpleModel();
        final KotlinRetrofit2RxJava2ClientCodegen codegen = new KotlinRetrofit2RxJava2ClientCodegen();
        codegen.setDateLibrary(KotlinRetrofit2RxJava2ClientCodegen.DateLibrary.JAVA8.value);
        codegen.processOpts();
